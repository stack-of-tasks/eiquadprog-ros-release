## eiquadprog (iron) - 1.2.9-2

The packages in the `eiquadprog` repository were released into the `iron` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release -r iron eiquadprog` on `Sun, 08 Dec 2024 20:46:14 -0000`
...
## eiquadprog (humble) - 1.2.9-2

The packages in the `eiquadprog` repository were released into the `humble` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release --new-track --rosdistro humble --track humble eiquadprog` on `Sat, 07 Dec 2024 10:41:05 -0000`
...
## eiquadprog (noetic) - 1.2.9-1

The packages in the `eiquadprog` repository were released into the `noetic` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release -r noetic eiquadprog` on `Sat, 07 Dec 2024 10:35:31 -0000`
...
## eiquadprog (iron) - 1.2.9-1

The packages in the `eiquadprog` repository were released into the `iron` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release --new-track --rosdistro iron --track iron eiquadprog` on `Sun, 27 Oct 2024 11:42:49 -0000`
...
## eiquadprog (humble) - 1.2.9-1

The packages in the `eiquadprog` repository were released into the `humble` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release --new-track --rosdistro humble --track humble eiquadprog` on `Sun, 27 Oct 2024 11:39:56 -0000`
...
## eiquadprog (noetic) - 1.2.5-1

The packages in the `eiquadprog` repository were released into the `noetic` distro by running `/usr/bin/bloom-release eiquadprog --rosdistro noetic` on `Mon, 24 Oct 2022 13:55:15 -0000`
...
## eiquadprog (noetic) - 1.2.4-1

The packages in the `eiquadprog` repository were released into the `noetic` distro by running `/usr/bin/bloom-release eiquadprog --rosdistro noetic` on `Wed, 07 Sep 2022 12:40:32 -0000`
...
## eiquadprog (melodic) - 1.2.4-1

The packages in the `eiquadprog` repository were released into the `melodic` distro by running `/usr/bin/bloom-release eiquadprog --rosdistro melodic` on `Wed, 07 Sep 2022 12:37:59 -0000`
...
## eiquadprog (noetic) - 1.2.3-1

The packages in the `eiquadprog` repository were released into the `noetic` distro by running `/home/nim/.local/bin/bloom-release --rosdistro noetic eiquadprog` on `Wed, 10 Mar 2021 23:19:37 -0000`
...
## eiquadprog (melodic) - 1.2.3-1

The packages in the `eiquadprog` repository were released into the `melodic` distro by running `/home/nim/.local/bin/bloom-release --rosdistro melodic eiquadprog` on `Wed, 10 Mar 2021 23:03:25 -0000`
